...
<section class="home-section">
  <div class="section-heading">
    <p class="section-kicker">
      <span data-lang="en">Academic Path</span>
      <span data-lang="zh">教育经历</span>
    </p>
    <h2>
  ...
  <div class="education-grid">
    <article>
      <span>2020 - 2024</span>
      <h3>
        <span data-lang="en">Ph.D. in Artificial Intelligence</span>
        <span data-lang="zh">人工智能博士</span>
      </h3>
      <p>
        <span data-lang="en">School of Artificial Intelligence, Jilin University</span>
        <span data-lang="zh">吉林大学人工智能学院</span>
      </p>
      <p>
        <span data-lang="en">Mentors:</span>
        <span data-lang="zh">导师：</span>
        <a href="http://fausto.disi.unitn.it/">Prof. Fausto Giunchiglia</a>
        <span class="mentor-honor">
          <span data-lang="en">Foreign Member of the Chinese Academy of Sciences; Member of Academia Europaea</span>
          <span data-lang="zh">中国科学院外籍院士、欧洲科学院院士</span>
        </span>
        <span data-lang="en">and</span>
        <span data-lang="zh">与</span>
        <a href="https://ccst.jlu.edu.cn/info/1367/19077.htm">Prof. Hao Xu</a>
      </p>
    </article>
    <article>
      <span>2018 - 2020</span>
      <h3>
        <span data-lang="en">M.S. in Computer Science and Technology</span>
        <span data-lang="zh">计算机科学与技术硕士</span>
      </h3>
      <p>
        <span data-lang="en">College of Computer Science and Technology, Jilin University</span>
        <span data-lang="zh">吉林大学计算机科学与技术学院</span>
      </p>
      <p>
        <span data-lang="en">Mentor:</span>
        <span data-lang="zh">导师：</span>
        <a href="https://ccst.jlu.edu.cn/info/1194/17198.htm">Prof. Lan Huang</a>
      </p>
    </article>
    <article>
      <span>2014 - 2018</span>
      <h3>
        <span data-lang="en">B.S. in Software Engineering</span>
        <span data-lang="zh">软件工程学士</span>
      </h3>
      <p>
        <span data-lang="en">School of Software Engineering, Jilin University</span>
        <span data-lang="zh">吉林大学软件学院</span>
      </p>
    </article>
  </div>
</section>
...
<section class="home-section" id="news">
  <div class="section-heading">
    <p class="section-kicker">
      <span data-lang="en">Recent Updates</span>
  ...
  <div class="timeline-list expandable-items" data-expand-list data-step="2">
    <article>
      ...
      <p data-lang="zh">论文 "Bottom-Up Competition Based on Label Hierarchy Trees for In-Context Learning with Large Label Space" 被 <em>Information Fusion</em> 接收，IF 17.4。</p>
    </article>
    <article>
      <time>2026-08-21</time>
      <p data-lang="en">Our paper "Jasper-Flash: Elastic Token Compression and Progressive Distillation for Inference-Scalable Text Embedding Models" has been accepted by <em>EMNLP 2026 main</em>, CCF B.</p>
      <p data-lang="zh">论文 "Jasper-Flash: Elastic Token Compression and Progressive Distillation for Inference-Scalable Text Embedding Models" 被 <em>EMNLP 2026 main</em> 接收，CCF B。</p>
    </article>
    <article>
...
<section class="home-section" id="publications">
  ...
  <div class="publication-list expandable-items" data-expand-list data-step="3">
    ...
    <article class="publication-item">
      <div class="publication-meta"><span>ACL 2026 Main | CCF A</span></div>
    ...
    <article class="publication-item">
      <div class="publication-meta"><span>AAAI 2024 | CCF A</span></div>
...
<section class="home-section">
  <div class="section-heading">
    <p class="section-kicker">
      <span data-lang="en">Funded Research</span>
      <span data-lang="zh">科研项目</span>
    </p>
    <h2>
  ...
  <div class="project-grid">
    <article>
      <h3>
        <span data-lang="en">China Postdoctoral Science Foundation</span>
        <span data-lang="zh">中国博士后科学基金第76批面上资助</span>
      </h3>
      <p data-lang="en">Research on mitigating out-of-distribution bias in large language model in-context learning.</p>
      <p data-lang="zh">大语言模型上下文学习中的分布外偏见缓解方法研究。</p>
    </article>
    <article>
      <h3>
        <span data-lang="en">Jilin Provincial Natural Science Foundation</span>
        <span data-lang="zh">吉林省自然科学基金面上项目</span>
      </h3>
      <p data-lang="en">Research on shortcut learning mitigation for large language model in-context learning.</p>
      <p data-lang="zh">面向大语言模型上下文学习的捷径学习缓解方法研究。</p>
    </article>
    <article>
      <h3>
        <span data-lang="en">Jilin Provincial Department of Education</span>
        <span data-lang="zh">吉林省教育厅科学研究项目</span>
      </h3>
      <p data-lang="en">Excellent Young Scholar research project.</p>
      <p data-lang="zh">优秀青年项目。</p>
    </article>
  </div>
</section>
